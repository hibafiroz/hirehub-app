...
function JobseekerLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.password) {
      newErr.passwordErr = 'Please enter your email'
    }
    ...
    setLoggingIn(true)
    try {
      const loginPost = await API.post("/authentication/jobseeker-Login", formData);
  ...
  return (
    <>
      ...
      <AnimatedSection>
        <div className="mt-4 relative min-h-screen flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 px-4 sm:px-6">
