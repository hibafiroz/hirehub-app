...
function RecruiterLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const loginPost = await API.post("/authentication/recruiter-Login", formData);
  ...
  return (
    <>
      ...
      <AnimatedSection>
        <div className="mt-4 relative min-h-screen flex items-center justify-center gap-20 px-4">

          {/* LEFT SIDE */}
          <div className="hidden lg:flex flex-col mb-10 mt-10">
            <div className="relative z-10 space-y-6 py-12">
              <h1 className="text-5xl text-slate-900 font-semibold">
                <div>Welcome back,</div>
                <div>
                  hire the top{" "}
                  <span className="text-teal-700">talent</span>
                </div>
                <div className="text-teal-700">faster with ease</div>
              </h1>

              <p className="text-sm text-teal-600 leading-relaxed">
                Manage job postings, track applicants,
                <br />
            ...
            <div className="relative z-10 space-y-3">
              <div className="flex items-center gap-3 bg-white/30 p-2 shadow-[0_10px_20px_rgba(15,118,110,0.45)] border border-black/20 rounded-2xl text-sm">
                <div className="w-8 h-8 rounded-xl flex items-center justify-center border border-black/20 text-xs">
                  01
                </div>
              ...
              <div className="flex items-center p-2 bg-white/30 shadow-[0_18px_40px_rgba(15,118,110,0.45)] border border-black/20 rounded-2xl gap-3 text-sm">
                ...
                <p className="text-teal-700">
                  Manage and shortlist applicants
                </p>
              </div>
            </div>
          </div>
          ...
          {/* RIGHT SIDE (FORM) */}
          <div className="px-5 sm:px-8 lg:px-10 py-8 sm:py-10 lg:py-12 mt-8 sm:mt-12 w-full max-w-[400px] rounded-3xl bg-white/30 shadow-[0_18px_50px_rgba(15,118,110,0.45)] backdrop-blur">
            <div>
